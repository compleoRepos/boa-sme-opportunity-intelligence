...
export const DEMO_STEPS: DemoStep[] = [
  ...
  { id: 'ml', route: '/back-office/modeles', persona: 'backoffice', target: 'models', title: 'ML Governance', say: '« Le modèle de propension est enregistré, versionné et verrouillé en POC_SHADOW. »', value: 'Le ML est mesuré sans compléter ni réordonner la priorité des règles ; il ne décide pas du crédit.', action: 'Ouvrir la version active et son historique.' },
]
