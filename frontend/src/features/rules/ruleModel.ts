...
export const OPPORTUNITY_TYPES: Array<[string, string]> = [['INVESTMENT_FINANCING', 'Financement d’investissement'], ['WORKING_CAPITAL', 'Financement BFR'], ['TRADE_FINANCE', 'Trade finance'], ['CASH_INVESTMENT', 'Placement de trésorerie'], ['FLOW_DOMICILIATION', 'Domiciliation des flux'], ['FINANCIAL_STRESS_SIGNAL', 'Signal de tension financière']]
