...
describe('Rule Studio — lecture et édition', () => {
  it('affiche la règle en SI / ET / ALORS lisible par le métier', () => {
    render(<ReadableRule conditions={conditions} logic="AND" recommendation={{ opportunityType: 'INVESTMENT_FINANCING', products: ['BOA_CREDIT_MLTD_DIRECT'], horizon: '1-3_MONTHS' }} products={{ BOA_CREDIT_MLTD_DIRECT: 'Crédit MLTD Direct' }} />)
    ...
    expect(screen.getByText('Crédit MLTD Direct')).toBeInTheDocument()
