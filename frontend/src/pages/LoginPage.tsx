  ...
  return <main className="login">
    <section className="login-brand">
      ...
      <div>
        ...
        <p>Une lecture claire des opportunités commerciales de chaque portefeuille PME : priorités explicables issues des règles, propension ML observée en shadow et actions, dans un seul cockpit.</p>
