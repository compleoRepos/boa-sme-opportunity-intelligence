...
required=(
  ...
  NOTIFICATION_DB_PASSWORD FINANCIAL_INTELLIGENCE_DB_PASSWORD
)
...
bootstrap_role_schema financial_intelligence_service financial_intelligence "$FINANCIAL_INTELLIGENCE_DB_PASSWORD"
