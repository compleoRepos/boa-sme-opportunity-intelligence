"""Catalogue commercial BANK OF AFRICA pour les entreprises et PME.

Source unique du catalogue produit utilisé par le seed, le service mock-banking et
les tests. Chaque produit est un produit réellement commercialisé par BANK OF AFRICA
(Maroc) et relevé sur ses pages publiques ; `source_url` renvoie vers la page produit.
...
class CatalogProduct:
    ...
    description: str
    source_url: str
    target_segments: tuple[str, ...] = ("SMALL", "MEDIUM")
...
def _p(
    ...
    description: str,
    path: str,
    segments: tuple[str, ...] = ("SMALL", "MEDIUM"),
    **eligibility: object,
) -> CatalogProduct:
...
BOA_PRODUCTS: tuple[CatalogProduct, ...] = (
    ...
    _p(
        ...
        "FINANCING",
        "INVESTMENT_FINANCING",
        "Crédits d'investissement et de trésorerie destinés aux entreprises, PME, "
    ...
    _p(
        ...
        "GUARANTEE",
        "INVESTMENT_FINANCING",
        "Crédit d'investissement bénéficiant d'une garantie d'organisme étatique.",
    ...
    _p(
        ...
        "Financement des effets de commerce domestiques avant leur échéance.",
    ...
    _p(
        ...
        "GUARANTEE",
        "WORKING_CAPITAL_FACILITY",
        "Garantie publique couvrant jusqu'à 60 % des crédits de fonctionnement "
    ...
    _p(
        ...
        "FINANCING",
        "WORKING_CAPITAL_FACILITY",
        "Avance de trésorerie adossée à un marché public nanti.",
    ...
    _p(
        ...
        "FINANCING",
        "OVERDRAFT",
        "Facilité de caisse adaptée aux activités périodiques et saisonnières, avec "
        "remboursement échelonné sur 6 à 12 mois.",
    ...
    _p(
        ...
        "TRADE",
        "TRADE_FINANCE",
        "Garantie de paiement à première demande en couverture d'une transaction "
        "internationale.",
    ...
    _p(
        ...
        "PAYMENT",
        "CASH_MANAGEMENT",
        "Exécution de virements en volume (salaires, fournisseurs) depuis un fichier.",
    ...
    _p(
        ...
        "INVESTMENT",
        "TERM_DEPOSIT",
        "Placement à durée fixe (1 à 24 mois) rémunéré par des intérêts nets, à partir "
        "de 5 000 DH, avec possibilité d'avance.",
    ...
    _p(
        ...
        "professionnels, pour diversifier les excédents de trésorerie.",
